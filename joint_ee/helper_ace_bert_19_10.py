...
if __name__ == "__main__":
    sent_file='test_oct.sent'#print(sys.argv[1])
    point_file='test_trim_oct.pointer'#print(sys.argv[2])
    pos_file='test_oct.pos'#print(sys.argv[3])
    ent_file='test_oct.ent'
    bert_sent_file='test_bert.sent'#print(sys.argv[4])
    bert_point_file='test_bert.pointer'#print(sys.argv[5])
    bert_pos_file='test_bert.pos'
    bert_ent_file='test_bert.ent'
